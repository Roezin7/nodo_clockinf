...
4. Da de alta cada dispositivo desde Configuración y usa su código de enrolamiento de un solo uso en `/kiosk`. No distribuyas un token global entre tablets.
